...
interface BuyItinerarySectionProps {
  placeId: string;
  placeName: string;
  duration: string;
}

export default function BuyItinerarySection({ placeId, placeName, duration }: BuyItinerarySectionProps) {
 ...
 return (
    <>
      ...
      {/* ✅ New Improved PDF Preview Modal */}
      {showPreview && (
