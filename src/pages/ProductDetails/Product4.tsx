...
import product41 from "@/assets/product4.png";
...
const MOCK_PRODUCT: Product = {
  ...
  subtitle: "Cute + cozy = the slippers you didn’t know you need!",
  price: "€9.88",
 // compareAt: "€49",
//discount: "40% OFF",
  shortDescription:
    "Soft, snuggly, and effortlessly cute — these Blue Bow Slippers are your new cozy essential. With their plush feel and adorable bow detail, they add a touch of charm to your lazy mornings and chill nights at home.",
  heroImage:
    product41,
  gallery: [
    product42, product43, product44
  ],
  items: [
  ...
  whyILoveIt: [
    "Soft and cozy — perfect for lazy mornings or chill nights 💙",
    "Adorable bow detail adds that extra touch of cuteness",
    "Lightweight and comfy for all-day lounging",
    "Keeps your feet warm while still feeling breathable and plush ✨",
  ],
...
function FAQSection() {
  const faqs = [
    {
      q: "What material are the Blue Bow Slippers made of?",
      a: "They're crafted from soft, plush fabric with a cozy inner lining — perfect for keeping your feet warm and comfy all day long.",
    },
    {
      q: "Are they suitable for all seasons?",
      a: "Yes! They’re lightweight enough for summer mornings yet warm and snug for chilly nights — perfect year-round comfort.",
    },
    {
      q: "How do they fit?",
      a: "They fit true to size! But if you’re between sizes or prefer a looser feel, we recommend sizing up for extra comfort.",
    },
    {
      q: "How do I care for them?",
      a: "Hand wash gently with mild soap and air dry. Avoid machine washing or heat drying to keep them fluffy and soft.",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-50 to-white dark:from-slate-950 dark:to-slate-900 text-slate-900 dark:text-slate-100 transition-colors duration-500">
      ...
      */}
      ...
      <a
        href="https://onelink.shein.com/17/52zzzrl48k7n"
        target="_blank"
